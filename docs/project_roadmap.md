...
模拟盘稳定性账本与策略验证专项设计见：`docs/superpowers/specs/2026-07-11-simulation-stability-ledger-design.md`。当前状态为“设计已批准、待实现”；该文档从属于本文，并进一步细化 SQLite 运行账本、订单幂等、自动对账、观察型风控和 20 个有效交易日验收方案，不代表相关能力已经落地。
